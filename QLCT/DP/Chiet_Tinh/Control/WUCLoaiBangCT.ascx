<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCLoaiBangCT.ascx.cs" Inherits="Chiet_Tinh_Control_WUCLoaiBangCT" %>
...
<div style="text-align:left; width:100%">
    <div>
        ...
        <div class="DQ_Box_Top_Center" style="padding-left:8px;">            
            <asp:Label ID="LTieuDe" runat="server" Text="Quản lý loại bảng chiết tính" />
        </div>
    </div>
    <div class="DQ_Box_Middle" style=" padding: 5px 5px 20px 5px">
        ...
        <div>
            ...
            EnableAjax="false" oncellselectionchanged="MyGrid01_CellSelectionChanged" EnableDataViewState="true" 
                ...
                onpageindexchanged="MyGrid01_PageIndexChanged" 
                ...
                <Behaviors>
                    ...
                    <ig:Paging Enabled="true" PagerAppearance="Bottom" PageSize="8" />
                ...
                <Columns>
                    <ig:BoundDataField DataFieldName="Ma_Loai" Key="K1">
                        <Header Text="Mã loại bảng chiết tính" />
                    </ig:BoundDataField>
                    <ig:BoundDataField DataFieldName="Ten_Loai" Key="K2">
                        <Header Text="Tên loại bảng chiết tính" />
                    </ig:BoundDataField>                                        
                    <ig:BoundDataField DataFieldName="Ghi_Chu" Key="K3">
                        <Header Text="Ghi chú" />
                    </ig:BoundDataField>                    
                </Columns>
            </ig:WebDataGrid>
        ...
        <div>
            <div style="padding: 20px 3px 0px 30px">        
                <table cellpadding="3" cellspacing="3">
                    <tr>
                        ...
                        <td>                            
                            ...
                            ControlToValidate="WMaLoai" ValidationGroup="CNDMDonVi" />
                        </td>
                        <td>
                            &nbsp;&nbsp;&nbsp;
                        ...
                        <td>
                            ...
                            ControlToValidate="WTenLoai" ValidationGroup="CNDMDonVi" />
                        </td>
                    </tr>                    
                    <tr>
                        <td>
                ...
                <div style="padding-left:18px;">                    
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="WIBCapNhat" runat="server" Text="Sửa" 
