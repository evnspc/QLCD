<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCLoaiChiPhi.ascx.cs" Inherits="Chiet_Tinh_Control_WUCLoaiChiPhi" %>
        ...
        <div>
            <div style="padding: 20px 3px 0px 30px">        
                <table cellpadding="3" cellspacing="3">
                    <tr>
                        ...
                        <td>                            
                            ...
                            ControlToValidate="WMaLoai" ValidationGroup="CNLoaiChiPhi" />
                        </td>
                        <td>
                            &nbsp;&nbsp;&nbsp;
                        ...
                        <td>
                            ...
                            ControlToValidate="WTenLoai" ValidationGroup="CNLoaiChiPhi" />
                        </td>
                    </tr>                   
                    <tr>
                        <td>
                ...
                <div style="padding-left:18px;">                    
                    ...
                    Width="100px" ValidationGroup="CNLoaiChiPhi" onclick="WIBThemMoi_Click" />
                    &nbsp;&nbsp;
                    <asp:Button ID="WIBCapNhat" runat="server" Text="Ghi" 
                    Width="100px" ValidationGroup="CNLoaiChiPhi" 
                    onclick="WIBCapNhat_Click" />
                    &nbsp;&nbsp;
                    <asp:Button ID="WIBXoa" runat="server" Text="Xóa" 
                    Width="100px" ValidationGroup="CNLoaiChiPhi" onclick="WIBXoa_Click" />
                    &nbsp;&nbsp;
