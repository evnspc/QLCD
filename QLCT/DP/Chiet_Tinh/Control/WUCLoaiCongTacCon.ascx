<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCLoaiCongTacCon.ascx.cs" Inherits="Chiet_Tinh_Control_WUCLoaiChiPhi" %>
...
<div style="text-align:left; width:100%">
    <div>
        ...
        <div class="DQ_Box_Top_Center" style="padding-left:8px;">            
            <asp:Label ID="LTieuDe" runat="server" Text="Quản lý loại công tác con" />
        </div>
    </div>    
            ...
            ScrollBars="Auto" style="padding-right:2px;">
                ...
                EnableDataViewState="true" EnableAjax="false" 
                    ...
                    <Columns>
                        ...
                        <ig:BoundDataField DataFieldName="Ten_Loai_Cha" Key="K3">
                            <Header Text="Tên loại cha" />
                        </ig:BoundDataField>                                                                
                    </Columns>
                </ig:WebDataGrid>
            </asp:Panel>
            ...
            <div style="padding: 20px 3px 0px 30px">        
                <table cellpadding="3" cellspacing="3">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <asp:DropDownList ID="DDLLoaiCha" runat="server" Width="300px" 
                            DataValueField="Ma_Loai" DataTextField="Ten_Loai">
                            </asp:DropDownList>
                        </td>
                    </tr>                                                       
                </table>                
