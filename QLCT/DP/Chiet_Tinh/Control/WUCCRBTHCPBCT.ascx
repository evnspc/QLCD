<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCCRBTHCPBCT.ascx.cs" Inherits="Chiet_Tinh_Control_WUCReport" %>
...
<div>
    <div>
        <table style="vertical-align:top" cellpadding="5px">
            <tr>
                <td>
                    &nbsp;&nbsp;
                    Từ ngày lập:
            ...
            <tr>
                ...
                <td>                
                    <asp:DropDownList ID="DDLLChietTinh" runat="server" Width="150px">
                ...
                <td>                
                    <asp:DropDownList ID="DDLXuatKho" runat="server" Width="120px">
                        <asp:ListItem Text="Tất cả" Value="2" />
                        <asp:ListItem Text="Đã thực hiện" Value="0" />
                        <asp:ListItem Text="Chưa thực hiện" Value="1" />
                    </asp:DropDownList>
                </td>
            </tr>        
        </table>
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CRSND" runat="server">
            <Report FileName="~/Chiet_Tinh/Control/CRBaoCaoCP01.rpt">
            </Report>        
