...
<div style="text-align:left; width:100%">
    ...
    <div class="DQ_Box_Middle" style=" padding: 5px 5px 10px 15px">
        <div style="padding: 3px;">
            <a href='<% = ResolveUrl("~/Chiet_Tinh/QLBangChietTinh.aspx") %>' class="DQ_Menu_Link">Quản lý bảng chiết tính</a>
        </div>
        <div style="padding: 3px;">
            <a href='<% = ResolveUrl("~/Chiet_Tinh/TraCuuBangCT.aspx") %>' class="DQ_Menu_Link">Tra cứu bảng chiết tính</a>
        </div>
        <div style="padding: 3px;">
