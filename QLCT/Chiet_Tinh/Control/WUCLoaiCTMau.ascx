<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WUCLoaiCTMau.ascx.cs" Inherits="Chiet_Tinh_Control_WUCLoaiChiPhi" %>
...
<div style="text-align:left; width:100%">
    <div>
        ...
        <div class="DQ_Box_Top_Center" style="padding-left:8px;">            
            <asp:Label ID="LTieuDe" runat="server" Text="Quản lý loại chiết tính mẫu" />
        </div>
    </div>    
